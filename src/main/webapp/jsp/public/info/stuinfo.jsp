...
<html>
<head>
	<title>个人信息-${student.name} | 毕业选题</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">个人信息-${student.name}</h3>
										<div id="toastr-demo" class="panel">
						<div class="panel-body">
							<p>
								<br>
								<label>ID</label>
								<input type="text" id="id" class="form-control" value="${student.id}" readonly="readonly" style="width:200px;">
								<br>
								<label>姓名</label>
								<input type="text" id="name" class="form-control" value="${student.name}" readonly="readonly" style="width:200px;">
								<br>
								<label>性别</label>
								<div>
									<label class="fancy-radio" style="float: left">
											<input name="gender" value="1" type="radio" disabled="disabled" <c:if test="${student.gender==1}">checked="checked"</c:if>>
											<span><i></i>男</span>
									</label>
									<label class="fancy-radio" style="float: left;padding-left: 20px">
											<input name="gender" value="2" type="radio" disabled="disabled" <c:if test="${student.gender==2}">checked="checked"</c:if>>
											<span><i></i>女</span>
								   </label>
								</div>
								...
								<br>
								<label>邮箱</label>
								<input type="text" id="email" class="form-control" value="${student.email}" readonly="readonly" style="width:200px;">
								<br>
								<label>手机</label>
								<input type="text" id="phone" class="form-control" value="${student.phone}" readonly="readonly" style="width:200px;">
								<br>
								<label>学院/系</label>
								<input type="text" id="dept" class="form-control" value="${student.dept}" readonly="readonly" style="width:200px;">
								<br>
								<label>专业</label>
								<input type="text" id="major" class="form-control" value="${student.major}" readonly="readonly" style="width:200px;">
								<br>
