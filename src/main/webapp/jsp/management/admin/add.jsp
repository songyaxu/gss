...
<body>
							...
							<div id='subPages3' class='collapse in'>
								<ul class='nav'>
									<c:if test="${user.id=='admin'}">
										<li><a href='${pageContext.request.contextPath}/manage/admin/add' class='active'>新增</a></li>
									</c:if>
    ...
    function add(){
        ...
        if(id==null||id=="")
        {
        	layer.msg("管理员ID不能为空", {icon: 5});
        	return;
        }
        if(name==null||name=="")
        {
        	layer.msg("管理员姓名不能为空", {icon: 5});
        	return;
        }	
        $.get("${pageContext.request.contextPath}/user/checkExist",{ id: id},
        		...
        		if(data.statusCode=="1"){
        	    	...
        	    	$.get("${pageContext.request.contextPath}/admin/add",{ id: id, name: name, password: password },
        	    		    function(data){
        	        		if(data.statusCode=="1"){
