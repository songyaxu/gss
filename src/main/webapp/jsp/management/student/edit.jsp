...
<body>
					...
					<div id="toastr-demo" class="panel">
						<div class="panel-body">
							<p>
								...
								<br>
								<label>姓名</label>
								<input type="text" id="name" class="form-control" value="${student.name}" style="width:200px;">
								<br>
								<label>性别</label>
								<div>
									<label class="fancy-radio" style="float: left">
											<input name="gender" value="1" type="radio" <c:if test="${student.gender==1}">checked="checked"</c:if>>
											<span><i></i>男</span>
									</label>
									<label class="fancy-radio" style="float: left;padding-left: 20px">
											<input name="gender" value="2" type="radio" <c:if test="${student.gender==2}">checked="checked"</c:if>>
											<span><i></i>女</span>
								   </label>
								</div>
								...
								<br>
								<label>邮箱</label>
								<input type="text" id="email" class="form-control" value="${student.email}" style="width:200px;">
								<br>
								<label>手机</label>
								<input type="text" id="phone" class="form-control" value="${student.phone}" style="width:200px;">
								<br>
								<label>学院</label>
								<input type="text" id="dept" class="form-control" value="${student.dept}" style="width:200px;">
								<br>
								<label>专业</label>
								<input type="text" id="major" class="form-control" value="${student.major}" style="width:200px;">
							</p>
							<hr>
							<p class="demo-button">
    ...
    function add(){
        ...
        var dept=$("#dept").val();
        var major=$("#major").val();
        $.get("${pageContext.request.contextPath}/student/update",{ id: id,name:name,gender:gender,email:email,phone:phone,dept:dept,major:major},
    		    function(data){
